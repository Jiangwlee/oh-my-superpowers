...
|---|----------|------|-----------|---------|------|
| A1 | [一句话写清楚行为假设] | 🔴 / 🟡 / 🟢 | [blast radius] | unit / integration / runtime log / spike | Spike S1 / 读文档（链接）/ 跳过 |
| A2 | ... | ... | ... | ... | ... |
...
- S1: ✅ [答案] → [设计修订说明]
- S2: ✅ [答案] → 无影响，原设计成立
- S3: 🟡 时间盒到，未完全消除 → [保留为 known risk 记入 Risk Register]

---

## 行动原则

> 从固定原则库（`references/principles-library.md`）中选取适用原则。**禁止**自创原则。
...
<!--
每个 Task 不得改动超过 5 个文件。如果一步超过 5 个文件，拆分它。
-->
...
- [ ] **Step 1: 识别需要更新的文档**
  ...
  - `docs/brainstorming/specs/` 下相关 spec 文档
