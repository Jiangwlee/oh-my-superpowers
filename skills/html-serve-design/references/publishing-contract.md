...
| `HTML_SERVE_BASE_URL` | no | Public URL base. Default: `http://localhost:${HTML_SERVE_PORT:-8888}`. |
...
```text
${HTML_SERVE_BASE_URL:-http://localhost:8888}/<project>/html-serve-design/<filename>.html
```
