...
free-form notes. Adding, removing, or reordering tasks is NOT the hot
path; edit tasks.yaml directly for those.
...
Invoke via: `omp coding-supervisor task update|show ...`
"""
