...
Do NOT add Read First / File Scope / Worker Refs sections. When dispatching
to a sub-agent, that context goes in the dispatch prompt, not here. Keeping
task.md stable means it doubles as the acceptance record.
-->
