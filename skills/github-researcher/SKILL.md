...
```bash
python3 skills/github-researcher/scripts/bootstrap_layout.py --memory-root .memory
```

### 3) Watchlist operations

```bash
python3 skills/github-researcher/scripts/watchlist.py add cli/cli --memory-root .memory
python3 skills/github-researcher/scripts/watchlist.py list --memory-root .memory
```

### 4) Deep analyze one repository (claude first, codex fallback)

```bash
python3 skills/github-researcher/scripts/analyze_repo.py cli/cli --memory-root .memory --mode deep
```
...
```bash
python3 skills/github-researcher/scripts/track_updates.py --memory-root .memory
```
