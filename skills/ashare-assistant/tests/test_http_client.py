...
class HttpClientTest(unittest.TestCase):
    ...
    @mock.patch("scripts.core.http_client.urllib.request.urlopen")
    def test_http_json_parses_dict(self, mock_urlopen: mock.Mock) -> None:
        resp = mock.Mock()
    ...
    @mock.patch("scripts.core.http_client.urllib.request.urlopen")
    def test_http_text_retries_then_succeeds(self, mock_urlopen: mock.Mock, mock_sleep: mock.Mock) -> None:
        resp = mock.Mock()
        resp.read.return_value = b"ok"
        mock_urlopen.side_effect = [OSError("boom"), mock.Mock(__enter__=mock.Mock(return_value=resp), __exit__=mock.Mock(return_value=False))]
    ...
    @mock.patch("scripts.core.http_client.urllib.request.urlopen")
    def test_http_bytes_returns_raw_bytes(self, mock_urlopen: mock.Mock) -> None:
        resp = mock.Mock()
