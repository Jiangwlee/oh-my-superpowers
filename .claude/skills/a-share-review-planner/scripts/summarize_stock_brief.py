...
用法：
    ...
    python3 summarize_stock_brief.py \
        --code 002050 \
        --em-raw /tmp/a-share-review/DATE/dr_002050_em.json \
        --tgb-raw /tmp/a-share-review/DATE/dr_002050_tgb.json \
        --output /tmp/a-share-review/DATE/dr_002050_compact.json \
        --compact-only
    ...
    python3 summarize_stock_brief.py \
        ...
        --em-raw /tmp/a-share-review/DATE/dr_002050_em.json \
        --tgb-raw /tmp/a-share-review/DATE/dr_002050_tgb.json \
        --output /tmp/a-share-review/DATE/dr_002050_brief.json
"""
