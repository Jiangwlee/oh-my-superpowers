...
def _all_gtimg_syms() -> list[str]:
    ...
    from scripts.fetchers.us_market import _INDICES, _TECH_STOCKS
...
class UsMarketFetcherTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._cache_patcher = patch(
            "scripts.fetchers.us_market.cache_get", return_value=None
        )
        self._cache_set_patcher = patch("scripts.fetchers.us_market.cache_set")
    ...
    def test_output_schema(self):
        ...
        with patch(
            "scripts.fetchers.us_market.http_bytes",
    ...
    def test_market_status_open(self):
        """美东时间周三 10:00 → open。"""
        from scripts.fetchers.us_market import _market_status_by_time
