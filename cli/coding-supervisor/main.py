...
# dependencies = ["typer"]
# ///
"""omp coding-supervisor — Story / task lifecycle helpers for the coding-supervisor skill.
...
Supervisor is free to edit story artifacts directly. These commands exist
only to keep the high-frequency updates atomic and auditable. No handoff,
no review prompt generation, no token usage aggregation — those belong to
the (deprecating) coding-orchestrator CLI.
"""
...
SCRIPTS = OMP_HOME / "skills" / "coding-supervisor" / "scripts"

app = typer.Typer(
    name="coding-supervisor",
    help="Story / task lifecycle helpers for the coding-supervisor skill.",
